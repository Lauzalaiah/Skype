...
Version 8.137.2 · Zéro dépendance · Node.js ≥ 18
...
npm test          # 259 tests de bout en bout (API, temps réel, sécurité, sons) — Node 22+
PORT=8080 npm start
```
...
259 tests couvrent l'inscription et la connexion, le rejet des identifiants invalides,

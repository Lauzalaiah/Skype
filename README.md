...
npm test          # 250 tests de bout en bout (API, temps réel, sécurité, sons) — Node 22+
PORT=8080 npm start
```
...
250 tests couvrent l'inscription et la connexion, le rejet des identifiants invalides,

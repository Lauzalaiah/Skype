...
## Film 30 secondes — « Le dimanche »

> **Intention** : montrer le contraste absolu entre la friction moderne et la simplicité
> retrouvée. Aucun dialogue explicatif, aucune voix off jusqu'aux 8 dernières secondes.

| Temps | Image | Son |
|---|---|---|
| 0:00–0:03 | Gros plan : des mains ridées sur un trackpad. Un écran affiche « Saisissez le code de la réunion ». | Silence. Tic-tac d'une horloge murale. |
...
## Film 60 secondes — « L'inventaire »

> **Intention** : version rythmée, montage rapide, pour le web et le préroll.

**0:00–0:20 — Le constat** *(montage serré, un plan par seconde, voix off sèche)*

> « On vous a donné des canaux.
> Des équipes. Des espaces. Des fils dans des fils.
> Des onglets, des liens, des codes, des salles d'attente.
> On vous a demandé de créer un compte professionnel
> pour souhaiter un bon anniversaire à votre frère. »

*Images : interfaces floutées, notifications qui s'empilent, un doigt qui scrolle sans fin,
une roue de chargement, une réunion à 9 participants où personne ne parle.*

**0:20–0:30 — Le retournement** *(le montage ralentit, la musique s'apaise)*

> « Pendant ce temps-là,
> tout ce que vous vouliez,
> c'était entendre quelqu'un. »

*Image : un visage seul devant un écran éteint.*
...
message vocal, sondage dans un groupe familial, thème sombre.*
...
*Silence. Puis : **blop**. Logo. Noir.*

---

## Spot radio — 20 secondes

> *(Ambiance : bureau feutré, cliquetis de clavier.)*
>
> **VOIX 1** *(agacée)* — Attends, il me demande un code de réunion.
> **VOIX 2** — Je te l'ai envoyé par mail.
> **VOIX 1** — Sur quelle adresse ?
> **VOIX 2** — La pro.
...
**Post 3 — son**
> 🔊 Montez le son.
> *(vidéo 3 secondes : écran noir, logo, puis le « blop »)*
> Vous venez d'avoir 17 ans pendant une seconde. De rien.

**Post 4 — utilité**
> On a remis : les émoticônes d'origine, le partage d'écran en un clic, les statuts de
> présence, les appels vers les vrais numéros, les groupes, les sondages, les messages
> vocaux, le thème bleu d'époque.
> On n'a rien enlevé. C'était un peu le principe.

**Post 5 — émotionnel, format court**
> Quelqu'un attend de vos nouvelles.
> Pas dans un canal. Pas à la prochaine réunion.
> Juste quelqu'un, qui serait content d'entendre votre voix ce soir.
> 💙
...
> Bonjour,
>
> On ne va pas vous faire un long discours.
>
> Vous aviez un pseudo. Des contacts. Des conversations qui remontaient à loin.
...
| Support | Format | Rôle |
|---|---|---|
| YouTube / préroll | Film 60 s + coupe 20 s | Notoriété, récit complet |
| TV / replay | Film 30 s « Le dimanche » | Émotion, cible 45+ |
| Facebook / Instagram | Posts 1, 3, 5 + film 30 s | Réactivation, partage |
| LinkedIn | Post 2 (comparatif) | Indépendants, freelances |
| Radio | Spot 20 s | Fréquence, humour de situation |
| Affichage urbain | Visuels A et B | Impact, mystère |
| E-mail | Reconquête | Conversion directe des anciens comptes |

**Indicateur clé** : réactivations de comptes dormants, pas installations brutes.
Le succès de cette campagne se mesure au nombre de personnes qui **reviennent**,
pas au nombre de nouvelles inscriptions.

...
|---|---|---|---|
| **Sonnerie** (appel entrant) | 2,6 – 7,4 s | oui | 0 – 1 s, pour espacer les répétitions |
...
| `Skypeforwindowsnew.mp3` | 0,99 s | fichier ou carte de contact envoyé |
...
| **Fin d'appel** | raccrochage | 0,4 – 1 s, motif descendant |
